...
export declare const setLocalStorageChatflow: (chatflowid: string, chatId: string, customerId: any, saveObj?: Record<string, any>) => void;
export declare const getLocalStorageChatflow: (chatflowid: string, customerId: string) => any;
export declare const removeLocalStorageChatHistory: (chatflowid: string, customerId: string) => void;
